...
import { SequencerGrid, NOTE_NAMES } from "@/components/editor/SequencerGrid";
import { useConnectedParamChecker } from "@/hooks/editor/useConnectedParam";
import { useAudioManager } from "@core-audio/client/AudioManagerContext";
...
export default function SequencerNode({ id, data, selected }: SequencerNodeProps) {
    ...
    }, [data.steps, id, lengthClamped, normalizeGrid, noteCount, onParameterChange]);
