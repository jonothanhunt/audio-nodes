...
export default function NodeHelpPopover({
    ...
    React.useEffect(() => {
        ...
        const onDocPointerDown = (e: PointerEvent) => {
            ...
            if (popoverRef.current && popoverRef.current.contains(t as Node))
                return;
            if (anchorRef.current && anchorRef.current.contains(t as Node))
                return;
            onClose();
        };
    ...
    return (
        ...
        >
            ...
            {title && (
                <div className="text-sm text-gray-100 font-medium mb-1">
                    {title}
                </div>
            )}
