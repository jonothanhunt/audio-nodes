...
export interface InitOutput {
    ...
    readonly miditransposenode_set_params: (
        a: number,
        b: number,
        c: number,
        d: number,
    ...
    readonly miditransposenode_transform: (
        a: number,
        b: number,
        c: number,
        d: number,
    ...
    readonly audioengine_process_audio: (
        a: number,
        b: number,
        c: number,
        d: any,
    ...
    readonly oscillatornode_process: (
        a: number,
        b: number,
        c: number,
        d: any,
